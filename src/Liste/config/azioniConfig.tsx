 ...
 * Ogni config collega poi l'onClick giusto e decide quando notificare.
 */
export const azioni = {
    ...
    trashSoft: (onClick: () => Promise<void> | void, title = "Elimina"): JSX.Element => (
        <button
            onClick={async () => {
                await onClick();
                // la notifica va inviata nel config con il tipo corretto
            }}
    ...
    restore: (onClick: () => Promise<void> | void, title = "Ripristina"): JSX.Element => (
        <button
            onClick={async () => {
                await onClick();
                // idem: la notifica va inviata dal config
            }}

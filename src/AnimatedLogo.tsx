...
export default function AnimatedLogo({ onFinish }: AnimatedLogoProps) {
    ...
    useEffect(() => {
        ...
        const totalDuration = paths.length * 500 + 2000;
    ...
    return (
        <>
            <BackgroundParticles />
            <div className={`logo-wrapper ${fadeOut ? "fade-out" : ""}`} style={{ position: "relative", zIndex: 1, paddingBottom: "80px" }}>
                <svg
                    className="logo-svg"
                    viewBox="0 0 743 150"
